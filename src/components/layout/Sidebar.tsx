...
export const Sidebar: React.FC = () => {
  ...
  const sidebarContent = (
    ...
    >
      ...
      {/* Main Feature Navigation (Chat, Activity, Saved, Tasks, Calendar, Meetings, Files, Admin) */}
          ...
          <div>
            <div className="flex items-center justify-between px-1 mb-1 text-slate-400 group">
              ...
              >
                ...
                <span>Mensajes Directos ({conversations.length})</span>
              </button>
              <button
